...
# Change strategy after initial strategy so that add noise to images to improve security.
strategy = DifferentialPrivacyClientSideFixedClipping(
    initial_strategy, noise_multiplier=0.15, clipping_norm=2, num_sampled_clients=3
)
